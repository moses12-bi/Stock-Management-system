...
const Dashboard = ({ stats }) => {
  ...
  const safeStats = {
    ...
    totalStockEntries: stats.totalStockEntries || 0,
    totalStockOutputs: stats.totalStockOutputs || 0
  };
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <DashboardCard
          ...
          value={safeStats.totalStockEntries}
          icon={
        ...
        />
        <DashboardCard
          title="Total Stock Outputs"
          value={safeStats.totalStockOutputs}
          icon={
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">New order #12345</td>
